...
public class CustomEventLogger implements AnalyticsListener {
     ...
     */
    public CustomEventLogger(String tag) {
        this.tag = tag;
     ...
     * @deprecated Use {@link androidx.media3.exoplayer.util.EventLogger ()}
     */
    @UnstableApi
    @Deprecated
     ...
     * @param trackSelector This parameter is ignored.
     * @param tag           The tag used for logging.
     * @deprecated Use {@link androidx.media3.exoplayer.util.EventLogger (String)}
     */
    @UnstableApi
    @Deprecated
    public CustomEventLogger(@Nullable MappingTrackSelector trackSelector, String tag) {
        this(tag);
    }
